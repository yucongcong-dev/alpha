...
Official URL: https://platform.worldquantbrain.com/learn/documentation/understanding-data/getting-started-option6-implied-volatility-iv
...
{
  "level": "2",
  "content": "Constant-Maturity Implied Volatility"
}
```
...
{
  "level": "2",
  "content": "Volatility Surface Shape (Skew, Slope, Curvature)"
}
```
...
{
  "level": "2",
  "content": "Earnings-Effect Series"
}
```
