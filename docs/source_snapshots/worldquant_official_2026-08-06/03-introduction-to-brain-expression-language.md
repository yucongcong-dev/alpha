...
Official URL: https://platform.worldquantbrain.com/learn/documentation/discover-brain/introduction-brain-expression-language
API Source: https://api.worldquantbrain.com/tutorial-pages/introduction-brain-expression-language
Captured: 2026-08-06
Official source: WorldQuant BRAIN Learn Documentation API
Capture method: official_api
Section: Discover BRAIN
Last modified: 2026-08-04T09:01:49.012743-04:00

## Metadata
```json
{
  "id": "introduction-brain-expression-language",
  "tutorial": "discover-brain",
  "tutorial_title": "Discover BRAIN",
  "title": "Introduction to BRAIN Expression Language",
  "url": "https://platform.worldquantbrain.com/learn/documentation/discover-brain/introduction-brain-expression-language",
  "lastModified": "2026-08-04T09:01:49.012743-04:00",
  "duration": "PT3M",
  "api_source": "https://api.worldquantbrain.com/tutorial-pages/introduction-brain-expression-language",
...
{
  "level": "1",
  "content": "What is Fast Expression?"
}
```
...
{
  "level": "1",
  "content": "Characteristics of Fast Expression"
}
```
...
### Image
- **title**: Datasets and data fields
- **width**: 1512
- **height**: 790
- **fileSize**: 74162
- **url**: https://api.worldquantbrain.com/content/images/gzrQKedTGErDXR6bhBdAD_k5yik=/177/original/dataset_1.png
...
- **height**: 373
- **fileSize**: 100643
- **url**: https://api.worldquantbrain.com/content/images/1VO4-FlZcwvL6jHR_8GEqoIOdBM=/178/original/Operators_1.png
...
{
  "level": "1",
  "content": "Further Knowledge of Fast Expression"
}
```
...
- **height**: 408
- **fileSize**: 143837
- **url**: https://api.worldquantbrain.com/content/images/ANQrIzvKFOUH6UMBe-crVIbRYwY=/179/original/Punctuation.png
