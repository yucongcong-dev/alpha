...
| 官网区域 | 本地覆盖 | 边界 |
|---|---|---|
| Learn Documentation | `2026-08-06` 已重新保存 `24/24` 篇正文、元数据和官方 URL；其中 `15` 篇来自 Learn API，`9` 篇来自 Chrome 登录后的官网渲染页面；目录无新增或删除 | `01-05` 只整合会改变研究、平台判断或操作流程的内容；完整例子和基础材料仍以原始快照为证据，不在主文档重复全文 |
