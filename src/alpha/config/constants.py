...
_EXPORT_GROUPS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ("._constants_api", tuple(_API_EXPORTS)),
    ("._constants_thresholds", tuple(_THRESHOLD_EXPORTS)),
    ("._constants_strings", tuple(_STRING_EXPORTS)),
    ("._constants_templates", tuple(_TEMPLATE_EXPORTS)),
    ("._constants_paths", tuple(_PATH_EXPORTS)),
)
