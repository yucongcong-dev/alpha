...
DATE_FORMAT_ISO_MINUTES: str = _yaml_str(
    "misc", "date_format_iso_minutes", default="%Y-%m-%d %H:%M"
)
...
STAT_FIELD_LOW_FITNESS: str = _yaml_str(
    "strings", "stat_fields", "low_fitness", default="low_fitness"
)
STAT_FIELD_CONCENTRATED_WEIGHT: str = _yaml_str(
    "strings", "stat_fields", "concentrated_weight", default="concentrated_weight"
)
STAT_FIELD_LOW_SUB_UNIVERSE_SHARPE: str = _yaml_str(
    "strings", "stat_fields", "low_sub_universe_sharpe", default="low_sub_universe_sharpe"
)
STAT_FIELD_FAILED_CHECK_COUNTS: str = _yaml_str(
    "strings", "stat_fields", "failed_check_counts", default="failed_check_counts"
)
STAT_FIELD_TOP_FAILED_CHECKS: str = _yaml_str(
    "strings", "stat_fields", "top_failed_checks", default="top_failed_checks"
)
STAT_FIELD_TEMPLATE_NAME: str = _yaml_str(
...
STAT_FIELD_ATTEMPTED_TEMPLATES: str = _yaml_str(
    "strings", "stat_fields", "attempted_templates", default="attempted_templates"
)

# ---- 模板 stage 名称 ----
TEMPLATE_STAGE_FIRST_ORDER: str = _yaml_str(
    "strings", "template_stages", "first_order", default="first_order"
)
TEMPLATE_STAGE_GROUP_SECOND_ORDER: str = _yaml_str(
    "strings", "template_stages", "group_second_order", default="group_second_order"
)
TEMPLATE_STAGE_EVENT_CONDITIONED: str = _yaml_str(
    "strings", "template_stages", "event_conditioned", default="event_conditioned"
)
...
NEUTRALIZATION_INDUSTRY: str = _yaml_str(
...
NEUTRALIZATION_SUBINDUSTRY: str = _yaml_str(
    "simulation", "neutralization", "subindustry", default="SUBINDUSTRY"
)
GROUP_NAME_SUBINDUSTRY: str = _yaml_str(
...
SIM_ACTIVE_STATES: frozenset[str] = frozenset(
    {SIM_STATE_PENDING, SIM_STATE_RUNNING, SIM_STATE_QUEUED}
)
SIM_TERMINAL_STATES: frozenset[str] = frozenset(
    {SIM_STATE_COMPLETED, SIM_STATE_FAILED, SIM_STATE_ERROR, SIM_STATE_CANCELLED}
)
