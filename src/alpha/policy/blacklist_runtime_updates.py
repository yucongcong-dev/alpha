"""Persistence and promotion rules for learned blacklist updates."""
...
def _build_blacklist_entry_from_runtime_summary(
    ...
    *,
    ...
    avg_sharpe = round(summary.sharpe_sum / sharpe_count, 3) if sharpe_count > 0 else None
    avg_fitness = round(summary.fitness_sum / fitness_count, 3) if fitness_count > 0 else None
